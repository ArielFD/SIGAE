              ...
              <form @submit.prevent.stop="onCreate">
                <q-card-section>
                  ...
                  <q-input
                    outlined
                    dense
                    v-model="data.comision_control"
                    label="Comisión"
                    style="max-width: 80%"
                    lazy-rules
                    :rules="alerts.inputRules"
                    ref="comision_control"
                  />
                  ...
                  <div style="max-width: 100%" v-if="data.tratamiento == 'si'">
                    ...
                    <div>
                      <q-item>
                        <q-item-section avatar style="width: 150px"
                          >Idoneidad:</q-item-section
                        >
                        <q-item-section>
                          <div>
                            <q-radio
                              v-model="data.idoniedad"
                              checked-icon="task_alt"
                              unchecked-icon="panorama_fish_eye"
                              val="si"
                              label="Si"
                    ...
                    <div>
                      <q-item>
                        <q-item-section avatar style="width: 150px"
                          >Estado tecnico:</q-item-section
                        >
                        <q-item-section>
                          <div class="row">
                            <q-radio
                              v-model="data.estadoTecnico"
                              checked-icon="task_alt"
                              unchecked-icon="panorama_fish_eye"
                              val="mal"
                              label="Mal"
                    ...
                    <div>
                      <q-item>
                        <q-item-section avatar style="width: 150px"
                          >Eficiencia:</q-item-section
                        >
                        <q-item-section>
                          <div>
                            <q-radio
                              v-model="data.eficiencia"
                              checked-icon="task_alt"
                              unchecked-icon="panorama_fish_eye"
                              val="mal"
                              label="Mal"
                  ...
                  <div>
                    <q-item>
                      <q-item-section avatar style="width: 150px"
                        >Política ambiental:</q-item-section
                      >
                      <q-item-section>
                        <div>
                          <q-radio
                  ...
                  <div>
                    <q-item>
                      <q-item-section avatar style="width: 150px"
                        >Diagnostico ambiental:</q-item-section
                      >
                      <q-item-section>
                        <div>
                          <q-radio
                  ...
                  <div class="column">
                    ...
                    <div class="row">
                      ...
                      <q-input
                        outlined
                        dense
                        v-model="data.cumplidas_mediano"
                  ...
                  <q-input
                    outlined
                    dense
                    v-model="data.consumo_energetico"
          ...
          <q-dialog v-model="data.cardEdit" persistent>
            <q-card class="my-card-to-pdf bg-primary" flat bordered>
              ...
              <form @submit.prevent.stop="onEdit">
                <q-card-section>
                  <div class="row">
                    ...
                    <q-input
                      outlined
                      dense
                      v-model="data.fechavisitaEdit"
                      type="date"
                      hint="Fecha de Visita"
                      lazy-rules
                      :rules="alerts.inputRules"
                      ref="fechavisitaEdit"
                    />
                  ...
                  <q-input
                    outlined
                    dense
                    v-model="data.atendido_porEdit"
                    label="Atendido por"
                    style="max-width: 80%"
                    lazy-rules
                    :rules="alerts.inputRules"
                    ref="atendido_porEdit"
                  />
                  <q-input
                    outlined
                    dense
                    v-model="data.comision_controlEdit"
                    label="Comisión"
                    style="max-width: 80%"
                    lazy-rules
                    :rules="alerts.inputRules"
                    ref="comision_controlEdit"
                  />
                  <div>Sistema de tratamiento:</div>
                  <div>
                    <q-radio
                      v-model="data.tratamientoEdit"
                      checked-icon="task_alt"
                      unchecked-icon="panorama_fish_eye"
                      val="si"
                      label="Si"
                  ...
                  >
                    ...
                    <div>
                      <q-item>
                        <q-item-section avatar style="width: 150px"
                          >Estado técnico:</q-item-section
                        >
                        <q-item-section>
                          <div>
                            <q-radio
                              v-model="data.estadoTecnicoEdit"
                              checked-icon="task_alt"
                              unchecked-icon="panorama_fish_eye"
                              val="mal"
                              label="Mal"
                  ...
                  >
                    ...
                    <div class="row">
                      ...
                      <q-input
                        outlined
                        dense
                        v-model="data.estadoRegularEdit"
                        type="number"
                        label="Regular"
                        class="q-pl-md"
                        style="max-width: 100px"
                  ...
                  <div class="column">
                    <div class="row">
                      <q-input
                        outlined
                        dense
                        v-model="data.medidas_cortoEdit"
                        label="Medidas a corto"
                        class="q-pa-sm"
                        type="number"
                        style="max-width: 150px"
                      ...
                      <q-input
                        outlined
                        dense
                        v-model="data.cumplidas_cortoEdit"
                        label="Cumplidas a corto"
                        class="q-pa-sm"
                        type="number"
                        style="max-width: 150px"
                    ...
                    <div class="row">
                      <q-input
                        outlined
                        dense
                        v-model="data.medidas_medianoEdit"
                        label="Medidas a mediano"
                        class="q-pa-sm"
                        type="number"
                        style="max-width: 150px"
                      ...
                      <q-input
                        outlined
                        dense
                        v-model="data.cumplidas_medianoEdit"
                        label="Cumplidas a mediano"
                        class="q-pa-sm"
                        type="number"
                        style="max-width: 150px"
                    ...
                    <div class="row">
                      <q-input
                        outlined
                        dense
                        v-model="data.medidas_largoEdit"
                        label="Medidas a largo"
                        class="q-pa-sm"
                        type="number"
                        style="max-width: 150px"
                      ...
                      <q-input
                        outlined
                        dense
                        v-model="data.cumplidas_largoEdit"
                        label="Cumplidas a largo"
                        class="q-pa-sm"
                        type="number"
                        style="max-width: 150px"
                  ...
                  <q-input
                    outlined
                    dense
                    v-model="data.consumo_energeticoEdit"
                    label="Consumo energético"
                    style="max-width: 200px"
                    class="q-pa-sm"
                    lazy-rules
                  ...
                  <q-input
                    ...
                    lazy-rules
                    :rules="alerts.inputRules"
                    ref="deficienciasEdit"
                  />
                  <q-input
                    v-model="data.recomendacionesEdit"
                    filled
                    type="textarea"
                    label="Recomendaciones"
                    class="q-pa-sm"
                  ...
                  />
                  <q-input
                    v-model="data.observacionesEdit"
                    filled
                    type="textarea"
                    label="Observaciones"
                    class="q-pa-sm"
                ...
                <q-checkbox
                  v-model="data.aprovechamientoEdit"
                  color="secondary"
                  label="Aprovechamiento de residuales"
                  true-value="si"
                  false-value="no"
                ...
                <aprovechamiento
                  v-if="data.aprovechamientoEdit == 'si'"
                  @addId="addingId"
                  @deleteId="deleteId"
                  :idResidual="data.id_ResidualEdit"
                />
...
function clear(params) {
  (model.value = ""), (data.tratamiento = "no");
  data.idoniedad = "";
  data.estadoTecnico = "";
  data.eficiencia = "";
  ...
  data.tipoGrasa = "no";
  data.estadoBien = "0";
  (data.estadoMal = "0"), (data.estadoRegular = "0");
  data.politica = "no";
  data.diagnostico = "no";
  ...
  (data.aprovechamiento = "no"), (data.id_ResidualEdit = []);
}
...
function generatePDF() {
  ...
  doc.text(
    "                                                                                          Fecha de la visita: " +
      data.fechavisitaEdit +
      "\n\n" +
      "Entidad: " +
      selected.value[0].entidad +
      "           Director: " +
      selected.value[0].director +
      "\n" +
      "Organismo: " +
      selected.value[0].organismo +
      "\n" +
      "Teléfono(s): " +
      selected.value[0].telefono +
      "\n\n" +
      "Atendido por: " +
      data.atendido_porEdit +
      "\n" +
      "Comisión de control: " +
      data.comision_controlEdit +
      "\n\n" +
      ...
      data.diagnosticoEdit +
      "\n\n" +
      "Medidas a corto:   " +
      data.medidas_cortoEdit +
      "       Cumplidas a corto: " +
      data.cumplidas_cortoEdit +
      "\n" +
      "Medidas a mediano: " +
      data.medidas_medianoEdit +
      "       Cumplidas a mediano: " +
      data.cumplidas_medianoEdit +
      "\n" +
      "Medidas a largo:   " +
      data.medidas_largoEdit +
      "       Cumplidas a largo: " +
      data.cumplidas_largoEdit +
      "\n\n" +
      "Consumo de agua: " +
      data.consumo_aguaEdit +
      "\n" +
      "Consumo energético: " +
      data.consumo_energeticoEdit +
      "\n\n" +
      "Deficiencias: " +
      data.deficienciasEdit +
      "\n\n\n" +
      "Recomendaciones: " +
      data.recomendacionesEdit +
      "\n\n\n" +
      "Observaciones: " +
      data.observacionesEdit +
      "\n\n\n" +
      "APROVECHAMIENTO ECONÓMICO: " +
      data.aprovechamientoEdit +
      "",
    10,
    10
  );
...
function getYear(params) {
  ...
  data.fechaImpresion =
    data.fechaImpresion.getDay() +
    "/" +
    data.fechaImpresion.getMonth() +
    "/" +
    data.fechaImpresion.getFullYear();
}
...
function editSistTrat() {
  return new Promise((resolve) => {
    ...
    api
      .put(
        `/sis-tratamientos/${selected.value[0].idSist}`,
        dataRest,
        authorization
      )
      .then(function (response) {
...
function editTrampa() {
  return new Promise((resolve) => {
    ...
    api
      .put(
        `/trampa-grasas/${selected.value[0].idTramp}`,
        dataRest,
        authorization
      )
      .then(function (response) {
...
async function Edit(params) {
  let sist, tramp;
  if (
    selected.value[0].idTramp == ""
      ? (tramp = await EditcreateTrampa())
      : (tramp = await editTrampa())
  )
    if (
      selected.value[0].idSist == ""
        ? (sist = await EditcreateSistTrat())
        : (sist = await editSistTrat())
    )
      data.entidades.forEach((element) => {
  ...
  await api
    ...
    .then(function (response) {
      ...
      data.rows.forEach((element) => {
        if (element.diagnostico_ambiental == "Si")
          element.diagnostico_ambiental = "si";
        if (element.diagnostico_ambiental == "No")
          element.diagnostico_ambiental = "no";
        if (element.politica_ambiental == "Si")
          element.politica_ambiental = "si";
        if (element.politica_ambiental == "No")
          element.politica_ambiental = "no";
      });
    })
    .catch(function (error) {
      console.log(error);
...
function onCreate() {
  ...
  if (
    modelo.value.hasError ||
    fechavisita.value.hasError ||
    atendido_por.value.hasError ||
    comision_control.value.hasError ||
    consumo_agua.value.hasError ||
    consumo_energetico.value.hasError ||
    deficiencias.value.hasError ||
    recomendaciones.value.hasError ||
    observaciones.value.hasError
  ) {
    alerts.alerts[0].message = "Rellene todo los campos obligatorios";
    $q.notify(alerts.alerts[0]);
    // form has error
  } else if (
    data.medidas_corto < data.cumplidas_corto ||
    data.medidas_mediano < data.cumplidas_mediano ||
    data.medidas_largo < data.cumplidas_largo
  ) {
    alerts.alerts[0].message =
      "La cantidad de medidas cumplidas debe ser menor que la cantidad de medidas propuestas";
    $q.notify(alerts.alerts[0]);
  } else {
    Create();
  }
...
function onEdit() {
  ...
  if (
    modeloEdit.value.hasError ||
    fechavisitaEdit.value.hasError ||
    atendido_porEdit.value.hasError ||
    comision_controlEdit.value.hasError ||
    consumo_aguaEdit.value.hasError ||
    consumo_energeticoEdit.value.hasError ||
    deficienciasEdit.value.hasError ||
    recomendacionesEdit.value.hasError ||
    observacionesEdit.value.hasError
  ) {
    alerts.alerts[0].message = "Rellene todo los campos obligatorios";
    $q.notify(alerts.alerts[0]);
    // form has error
  } else if (
    data.medidas_cortoEdit < data.cumplidas_cortoEdit ||
    data.medidas_medianoEdit < data.cumplidas_medianoEdit ||
    data.medidas_largoEdit < data.cumplidas_largoEdit
  ) {
    alerts.alerts[0].message =
      "La cantidad de medidas cumplidas debe ser menor que la cantidad de medidas propuestas";
    $q.notify(alerts.alerts[0]);
