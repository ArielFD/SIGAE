    ...
    <div class="col-12 q-pa-md">
        ...
        <div style="width: 100%" class="row justify-center" v-if="auth.printMode == true">
            <div class="col-3 text-h6">
                <q-btn flat :label="data.titulo" class="col-1  q-pa-xs" @click="auth.printMode = !auth.printMode" />
            </div>
        </div>
...
async function getEnfrentamiento(params) {
    ...
    await api
        .get(`/getPlanEnfrentamiento?filters[0]=${data.fecha_actual}&filters[1]=${data.organismo}&filters[2]=${data.organismos}&filters[3]=${data.osdes}`).then(function (response) {
            data3 = response.data
    ...
    await api
        .get(`/getPlanEnfrentamiento?filters[0]=${data.fecha_anterior}&filters[1]=${data.organismo}&filters[2]=${data.organismos}&filters[3]=${data.osdes}`).then(function (response) {
            data4 = response.data
        }).catch(function (error) {
            console.log(error);
        })
