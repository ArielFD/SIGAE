<template>
    <div class="col-12 q-pa-md">
        ...
        <div class="row justify-center" v-else>
            ...
            <p class="col-2">
                <label><b>Indicadores de desempeño:</b> </label> &nbsp;
            </p>
...
let data = reactive({
    titulo: "Histograma de indicadores de desempeño ",
...
async function getDesempeño(params) {
    ...
    await api
        .get(`/getIndicadoresDesempeno?filters[0]=${data.fecha_actual}&filters[1]=${data.opcion}&filters[2]=${data.organismos}&filters[3]=${data.osdes}&filters[4]=${data.indicador}`)
