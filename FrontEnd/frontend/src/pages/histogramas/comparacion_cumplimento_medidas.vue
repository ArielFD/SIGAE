<template>
    <div class="col-12 q-pa-md">
        ...
        <div class="row justify-between" v-else>
            ...
            <p class="col-6">
                <label><b>Comparación del porciento de cumplimiento de medidas en Actas de Control:</b> </label> &nbsp;
...
let data = reactive({
    titulo: "Histograma de comparación de cumplimento de medidas en Actas de Control ",
...
async function getEnfrentamiento(params) {
    ...
    await api
        .get(`/getMedidasActaControl?filters[0]=${data.fecha_actual}&filters[1]=${data.organismo}&filters[2]=${data.organismos}&filters[3]=${data.osdes}`)
        ...
        await api
        .get(`/getMedidasActaControl?filters[0]=${data.fecha_anterior}&filters[1]=${data.organismo}&filters[2]=${data.organismos}&filters[3]=${data.osdes}`)
        .then(function (response){
            data4=response.data;
        }).catch(function (error) {
            console.log(error);
